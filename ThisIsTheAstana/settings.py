"""
Django settings for ThisIsTheAstana project.
...
SECRET_KEY = 'django-insecure-&$xluej1ygxchnn$h68su+gyr4ww85&_--_$ft_+q(j&iqc@nk'
...
ROOT_URLCONF = 'ThisIsTheAstana.urls'
...
WSGI_APPLICATION = 'ThisIsTheAstana.wsgi.application'
