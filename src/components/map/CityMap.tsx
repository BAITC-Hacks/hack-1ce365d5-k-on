...
export function CityMap() {
  ...
  return <section className={`city-map ${selected ? 'has-selection' : ''}`} aria-label="Интерактивная карта Астаны">
    ...
    <div className="map-viewport" ref={stageRef}>
      <motion.div className="map-pan" drag dragConstraints={stageRef} dragElastic={0.15} dragMomentum={false} style={{ x: panX, y: panY }}>
