...
export function DistrictMarker({ district }: { district: District }) {
  ...
  return <div className="district-anchor map-anchor" data-layout-id={`district:${district.id}`} style={{ left: `${district.x}%`, top: `${district.y}%`, '--district-color': district.color } as CSSProperties}>
