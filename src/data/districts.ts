...
export const districts: District[] = [
  ...
  { id: 'almaty', name: 'Almaty', label: 'Алматы', description: 'Старые коммунальные сети и высокая нагрузка на дороги.', populationShare: 0.24, baseScore: 57.06, x: 71, y: 42, color: '#8ccbac', indicators: { T1: 40, T2: 75, E1: 50, E2: 55, S1: 60, S2: 65, B1: 62, B2: 52, C1: 50, C2: 60 }, priority: 'Надёжное ЖКХ и транспорт' },
